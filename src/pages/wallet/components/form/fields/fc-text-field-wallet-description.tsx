...
export function FcTextFieldWalletDescription() {
  ...
  const { invalidFields } = useFormWallet((state) => { return { invalidFields: state.invalidFields } });
  ...
  return <FcTextFieldDescription value={description} onChange={onChange} invalidFields={invalidFields} />;
}
